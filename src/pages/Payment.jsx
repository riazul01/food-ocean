                ...
                <div className="mt-[1rem] flex items-start justify-between gap-[1rem]">
                    ...
                    <div className="w-[60%]">
                        ...
                        <form className="mt-[1rem]">
                            <label htmlFor="stripe" className="gradient-bg p-[1rem] w-[380px] h-[80px] flex items-center justify-between border-[1px] border-[#ddd] rounded-md shadow-md cursor-pointer">
                            ...
                            <label htmlFor="cashon" className="gradient-bg mt-[1.2rem] p-[1rem] w-[380px] h-[80px] flex items-center justify-between border-[1px] border-[#ddd] rounded-md shadow-md cursor-pointer">
                                <div className="flex items-center justify-start">
