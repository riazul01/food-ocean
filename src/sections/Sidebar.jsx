        ...
        <div onClick={(e) => e.stopPropagation()} className={`${toggle ? 'translate-x-0' : 'translate-x-[-100%]'} px-[1.4rem] py-[1rem] fixed top-0 left-0 w-[300px] h-[100vh] bg-[#122829] z-[99999] transition-transform duration-300`}>
            <div className="">
                ...
                <ul className="my-[1rem]">
                    ...
                    <NavLink to="/groceries/trending" onClick={() => setToggle(false)} className={`${pathAra[0] === 'trending' ? 'bg-[#173334]' : null} px-[0.8rem] py-[0.4rem] text-[#fff] text-[1.1rem] flex items-center hover:bg-[#173334] rounded-lg`}>
                        {pathAra[0] === "trending" && <MdKeyboardArrowRight className="text-[#fff] text-[1.3rem]"/>}
                        <span>Trending now</span>
                    </NavLink>
                    <NavLink to="/groceries/raw-products" onClick={() => setToggle(false)} className={`${pathAra[0] === 'raw-products' ? 'bg-[#173334]' : null} px-[0.8rem] py-[0.4rem] text-[#fff] text-[1.1rem] flex items-center hover:bg-[#173334] rounded-lg`}>
                        {pathAra[0] === "raw-products" && <MdKeyboardArrowRight className="text-[#fff] text-[1.3rem]"/>}
                        <span>Raw Products</span>
                    </NavLink>
                    <NavLink to="/groceries/beverages" onClick={() => setToggle(false)} className={`${pathAra[0] === 'beverages' ? 'bg-[#173334]' : null} px-[0.8rem] py-[0.4rem] text-[#fff] text-[1.1rem] flex items-center hover:bg-[#173334] rounded-lg`}>
                        {pathAra[0] === "beverages" && <MdKeyboardArrowRight className="text-[#fff] text-[1.3rem]"/>}
                        <span>Beverages</span>
                    </NavLink>
                    ...
                    <NavLink to="/user/profile" onClick={() => setToggle(false)} className={`${(pathAra[0] === "login" || pathAra[0] === "register" || pathAra[0] === "profile" || pathAra[0] === "update-profile") ? 'bg-[#173334]' : null} px-[0.8rem] py-[0.4rem] text-[#fff] text-[1.1rem] flex items-center hover:bg-[#173334] rounded-lg`}>
                        {(pathAra[0] === "login" || pathAra[0] === "register" || pathAra[0] === "profile" || pathAra[0] === "update-profile") && <MdKeyboardArrowRight className="text-[#fff] text-[1.3rem]"/>}
