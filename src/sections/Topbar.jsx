    ...
    return (
        <div className="pt-[0.8rem] h-[auto] w-full bg-[#173334]">
            <div className="mx-[auto] px-[0.4rem] text-[#fff] flex justify-center md:justify-between max-w-[1420px]">
                ...
                <p className="hidden md:block text-[1rem] font-[500]">Get <span className="text-[orange] font-bold">30% off</span> for first order with exciting gift box! <Link to="/offers/offer-details" className="underline">Learn more</Link></p>
