        ...
        <div className="w-full bg-[#173334]">
            <div className="mx-[auto] px-[0.4rem] py-[3rem] max-w-[1420px] flex justify-between">
                ...
                <div className="flex flex-col w-[18%]">
                    ...
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">About Us</Link>
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">Groceries</Link>
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">Raw Products</Link>
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">Beverages</Link>
                </div>

                <div className="flex flex-col w-[18%]">
                    <h1 className="text-[orange] text-[1.2rem] font-bold">Trending</h1>
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">Fruits</Link>
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">Vegetables</Link>
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">Top Products</Link>
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">Recent Products</Link>
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">Popular Now</Link>
                </div>
                
                <div className="flex flex-col w-[18%]">
                    <h1 className="text-[orange] text-[1.2rem] font-bold">Quick Links</h1>
                    <Link to="" className="mt-[0.6rem] text-[#fff] text-[1.1rem]">User Account</Link>
