        ...
        <AppLayout>
            <div className="mx-auto pb-[1.4rem] max-w-[1420px] flex items-center justify-center">
                <div className="my-[1rem] w-[380px] h-auto min-h-[50vh]">
                    ...
                    <p className="text-[#182828] text-[1.1rem]">Please create an account to continue!</p>
                    ...
                    <div className="mt-[1rem] flex items-center">
                        <p className="me-[0.6rem] text-[1.1rem]">Already have an account?</p>
                        <Link to="/user/login" className="text-[1.1rem] underline">Login now</Link>
                    </div>
                </div>
            </div>
        </AppLayout>
