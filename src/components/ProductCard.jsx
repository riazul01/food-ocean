    ...
    return (
        ...
        {data && <div className="relative w-[100%] max-w-[280px] h-[360px] p-[0.2rem] border-[1px] border-gray-200 rounded-md shadow-lg overflow-hidden">
            ...
            <div className="relative w-full h-[45%] pl-[0.6rem] pt-[0.6rem]">
                ...
                <button onClick={handleAddToCart} className={`absolute left-0 bottom-0 py-[0.4rem] ${addedToCart ? 'w-[45%]': 'w-full'} bg-[#0c2a2b] text-[1.1rem] text-[orange] font-[500] outline-none rounded-sm z-[99]`}>{addedToCart ? 'Added👍' : 'Add to Cart 🛒'}</button>
